...
// ==/UserScript==
;
(()=>{var h=unsafeWindow,$=(e,...t)=>h.console.log(`%c[exlg] ${e}`,"color: #0e90d2;",...t),D=(e,...t)=>h.console.warn(`%c[exlg] ${e}`,"color: #0e90d2;",...t),T=(e,...t)=>{throw h.console.error(`%c[exlg] ${e}`,"color: #0e90d2;",...t),Error(t.join(" "))},b=null,E=null;location.host==="www.luogu.com.cn"&&!/blog/g.test(location.href)&&(/(\?|&)_contentOnly($|=)/g.test(location.search)&&T("Content-Only pages."),h._feInjection.code!==200&&T("Luogu failed to load. Exlg stops loading."),b=h._feInjection.currentData,E=h._feInjection.currentUser);var o=jQuery,G=new filterXSS.FilterXSS({onTagAttr:(e,t,r)=>{if(t==="style")return`${t}="${r}"`}});o.double=(e,t,r)=>[e(t),e(r)];Date.prototype.format=function(e,t){t=t?"UTC":"";let r={"y+":this[`get${t}FullYear`](),"m+":this[`get${t}Month`]()+1,"d+":this[`get${t}Date`](),"H+":this[`get${t}Hours`](),"M+":this[`get${t}Minutes`](),"S+":this[`get${t}Seconds`](),"s+":this[`get${t}Milliseconds`]()};for(let n in r)RegExp(`(${n})`).test(e)&&(e=e.replace(RegExp.$1,("000"+r[n]).substr(r[n].toString().length+3-RegExp.$1.length)));return e};String.prototype.toInitialCase=function(){return this[0].toUpperCase()+this.slice(1)};Array.prototype.lastElem=function(){return this[this.length-1]};var R=(e,t)=>{if(!e)return"<<";let r=(u,_)=>u===_?"==":u<_?"<<":">>",n=["pre","alpha","beta"],[[l,i],[a,s]]=[e,t].map(u=>u.split(" "));if(l===a)return r(...[i,s].map(u=>u?n.findIndex(_=>_===u):1/0));let[d,g]=[l,a].map(u=>u.split("."));for(let[u,_]of d.entries())if(_!==g[u])return r(+_||0,+g[u]||0)},K=(e=1)=>~~(new Date().getTime()/e),S=e=>new Promise((t,r)=>o.get(e+(e.includes("?")?"&":"?")+"_contentOnly=1",n=>{n.code!==200&&r(`Requesting failure code: ${t.code}.`),t(n)})),q=h.show_alert?(e,t="exlg 提醒您")=>h.show_alert(t,e):(e,t="exlg 提醒您")=>h.alert(t+`
`+e),X=null,B=(e,t)=>o.ajax({url:e,data:t,headers:{"x-csrf-token":X===null?X=o("meta[name=csrf-token]").attr("content"):X,"content-type":"application/json"},method:"post"}),P=({url:e,onload:t,onerror:r=n=>T(n)})=>GM_xmlhttpRequest({url:e,method:"GET",onload:t,onerror:r}),I=(e,t)=>{let r=new URLSearchParams;for(let l in e)r.set(l,e[l]);let n=o(`
        <iframe id="exlg-${e.type}" src=" https://www.bilibili.com/robots.txt?${r}" style="${t}" exlg="exlg"></iframe>
    `);return $("Building springboard: %o",n[0]),n},Z=e=>[/^AT[1-9][0-9]{0,}$/i,/^CF[1-9][0-9]{0,}[A-Z][0-9]?$/i,/^SP[1-9][0-9]{0,}$/i,/^P[1-9][0-9]{3,}$/i,/^UVA[1-9][0-9]{2,}$/i,/^U[1-9][0-9]{0,}$/i,/^T[[1-9][0-9]{0,}$/i].some(t=>t.test(e)),H={_ac_func:null,wrapper:null,container:null,wait_time:null,header:null,content:null,autoquit:!0,show_dialog(){this.wrapper.style.display="flex",setTimeout(()=>{this.container.classList.remove("container-hide"),this.container.classList.add("container-show")},50)},hide_dialog(){this.container.classList.add("container-hide"),this.container.classList.remove("container-show"),setTimeout(()=>this.wrapper.style.display="none",this.wait_time)},accept_dialog(){this._ac_func(this.hide_dialog),this.autoquit&&this.hide_dialog()},show_exlg_alert(e="",t="exlg 提醒您",r=()=>{},n=!0){this.autoquit=n,this._ac_func=r,this.header.innerHTML=t,this.content.innerHTML=e,this.show_dialog()}},A=(...e)=>H.show_exlg_alert(...e),J=async()=>{let e=(r,n)=>P({url:r,onload:l=>{let i=-1,a=l.response;[{errorcode:0,message:'"Succeed in creating a new badge!"',ontitle:"[exlg] 成功创建 badge",onlog:"Successfully created a badge!"},{errorcode:1,message:'"Wrong active code!"',ontitle:"无效激活码",onlog:"Illegal Active Code"},{errorcode:2,message:'"Sorry, but the active code has been used!"',ontitle:"激活码已被使用",onlog:"Expired Active Code"},{errorcode:3,message:'"Something went wrong!"',ontitle:"非法的 badge 内容",onlog:"Illegal Badge Text"},{errorcode:-1,message:"Fuck CCF up",ontitle:"未知错误",onlog:"注册 exlg-badge 时出现未知错误, 请联系开发人员"}].forEach(d=>{if(i===-1&&(console.log(a===d.message,d.errorcode===-1,d),(a===d.message||d.errorcode===-1)&&(i=d.errorcode,o("#exlg-dialog-title").html(d.errorcode?`[Error] ${d.ontitle}`:d.ontitle),$(d.errorcode?`Illegal Operation in registering badge: ${d.onlog}(#${d.errorcode})`:d.onlog),i===-1||!i))){n(),setTimeout(()=>A("badge 注册成功!","exlg 提醒您"),400);return}})}}),t="exlg badge 注册器 ver.5.0";A(`<div class="exlg-update-log-text exlg-unselectable exlg-badge-page" style="font-family: Consolas;">
    ...
    `,n=a=>a<=3?"":r.replace("%",a<=5?"#5eb95e":a<=7?"#3498db":"#f1c40f"),l=h.loadFeed;h.loadFeed=function(){h.feedMode==="all-exlg"?(P({url:e.source==="o2"?"https://service-ig5px5gh-1305163805.sh.apigw.tencentcs.com/release/APIGWHtmlDemo-1615602121":`https://bens.rotriw.com/api/list/proxy?page=${h.feedPage}`,onload:a=>{JSON.parse(a.response).forEach(d=>o(`
...
`);c.reg_hook_new("submission-color","记录难度可视化","@/record/list.*",null,async({args:e})=>{if(e&&e.type==="show"){if(o("div.problem > div > a > span.pid").length&&!o(".exlg-difficulty-color").length){let l=(await S(location.href)).currentData.records.result.map(i=>i.problem.difficulty);o("div.problem > div > a > span.pid").each((i,a,s=o(a))=>{s.addClass("exlg-difficulty-color").addClass(`color-${l[i]}`)})}return}if(o(".exlg-difficulty-color").length)return;let r=(await S(location.href)).currentData.records.result.map(n=>n.problem.difficulty);o(e.target).find("div.problem > div > a > span.pid").each((n,l,i=o(l))=>{i.addClass("exlg-difficulty-color").addClass(`color-${r[n]}`)})},e=>{let t=e.target;return!t||!t.tagName?{args:z.COMMENT_TAG,result:!1}:t.tagName.toLowerCase()==="a"&&(t.href||"").includes("/problem/")&&` ${t.parentNode.parentNode.className} `.includes(" problem ")?t.parentNode.parentNode.parentNode.nextSibling?{args:{type:"modified - not the last one.",target:null},result:!1}:{args:{type:"modified - update",target:t.parentNode.parentNode.parentNode.parentNode},result:!0}:{args:{type:"modified - not that one.",target:null},result:!1}},()=>({type:"show"}),"");c.reg("mainpage-discuss-limit","主页讨论个数限制",["@/"],{max_discuss:{ty:"number",dft:12,min:4,max:16,step:1,info:["Max Discussions On Show","主页讨论显示上限"],strict:!0}},({msto:e})=>{let t;location.href.includes("blog")||(o(".lg-article").each((r,n,l=o(n))=>{let i=n.childNodes[1];i&&i.tagName.toLowerCase()==="h2"&&i.innerText.includes("讨论")&&(t=l.children(".am-panel"))}),t.each((r,n,l=o(n))=>{r>=e.max_discuss&&l.hide()}))});c.reg("user-css","自定义样式表",".*",{css:{ty:"string"}},({msto:e})=>GM_addStyle(e.css));c.reg_chore("atdiff-fetch","获取_AtCoder_难度","10D","@/problem/AT.*",{atdiff:{ty:"string",priv:!0}},({msto:e})=>{let t={};P({url:"https://kenkoooo.com/atcoder/resources/problem-models.json",onload:r=>{let n=JSON.parse(r.responseText);for(let l in n)t[l]=n[l].difficulty;e.atdiff=JSON.stringify(t)}})});c.reg_pre("original-difficulty","显示原始难度",["@/problem/CF.*","@/problem/AT.*"],{cf_src:{ty:"enum",dft:"codeforces.com",vals:["codeforces.com","codeforces.ml"],info:["Codeforces problem source","CF 题目源"]}},async({msto:e})=>new Promise((t,r)=>{let n=location.pathname.match(/(CF|AT)([0-9]|[A-Z])*$/g)[0].substring(2);if(location.pathname.includes("CF")){let l=n.match(/^[0-9]*/g)[0],i=n.substring(l.length);P({url:`https://${e.cf_src}/problemset/problem/${l}/${i}`,onload:a=>{let s=o(a.responseText).find("span[title=Difficulty]").text().trim();t(s?s.substring(1):void 0)},onerror:a=>{T(a),r(a)}})}else{let l=JSON.parse(L["^atdiff-fetch"].atdiff),i=b.problem.description.match(RegExp("^.{22}[-./A-Za-z0-9_]*"))[0].match(RegExp("[^/]*$"));i in l?t(Math.round(l[i]>=400?l[i]:400/Math.exp(1-l[i]/400))):t(void 0)}}),({pred:e})=>{let t=document.querySelectorAll("div.field"),r=t[3].cloneNode(!0);t[3].after(r);let n=r.querySelectorAll("span");n[0].innerText="原始难度",n[1].innerText="获取中",e.then(l=>{l===void 0&&(l="不可用"),n[1].innerText=l})});c.reg("rand-problem-ex","随机跳题_ex","@/",{exrand_difficulty:{ty:"tuple",lvs:[{ty:"boolean",dft:!1,strict:!0,repeat:8}],priv:!0},exrand_source:{ty:"tuple",lvs:[{ty:"boolean",dft:!1,strict:!0,repeat:5}],priv:!0}},({msto:e})=>{let t=[["入门","red"],["普及-","orange"],["普及/提高-","yellow"],["普及+/提高","green"],["提高+/省选-","blue"],["省选/NOI-","purple"],["NOI/NOI+/CTSC","black"],["暂无评定","gray"]].map((m,w,x)=>({text:m[0],color:m[1],id:(w+1)%x.length})),r=[{text:"洛谷题库",color:"red",id:"P"},{text:"Codeforces",color:"orange",id:"CF"},{text:"SPOJ",color:"yellow",id:"SP"},{text:"AtCoder",color:"green",id:"AT"},{text:"UVA",color:"blue",id:"UVA"}],n=m=>{Z(m)&&(m=m.toUpperCase()),m===""||typeof m>"u"?h.show_alert("提示","请输入题号"):location.href="https://www.luogu.com.cn/problemnew/show/"+m},l=!1,i=!1,a=o("input[name='toproblem']");a.after(a.clone()).remove(),a=o("input[name='toproblem']");let s=o(".am-btn[name='goto']");s.after(s.clone()).remove(),s=o(".am-btn[name='goto']");let d=s.parent();o(".am-btn[name='gotorandom']").text("随机");let g=o('<button class="am-btn am-btn-success am-btn-sm" name="gotorandomex">随机ex</button>').appendTo(d);s.on("click",()=>{/^[0-9]+.?[0-9]*$/.test(a.val())&&a.val("P"+a.val()),n(a.val())}),a.on("keydown",m=>{m.keyCode===13&&s.click()});let u=o(`<span id="exlg-exrand-window" class="exlg-window" style="display: block;">
    <br>
    <ul></ul>
    </span>`).appendTo(d).hide().on("mouseenter",()=>{l=!0}).on("mouseleave",()=>{l=!1,i||u.hide()});o(".lg-index-stat>h2").text("问题跳转 ").append(o('<div id="exlg-dash-0" class="exlg-rand-settings">ex设置</div>'));let _=u.children("ul").css("list-style-type","none"),y=o('<div id="exlg-exrand-menu"></div>').appendTo(_);o("<br>").appendTo(_);let C=o('<div id="exlg-exrand-diff" class="smallbtn-list"></div>').appendTo(_),j=o('<div id="exlg-exrand-srce" class="smallbtn-list"></div>').appendTo(_).hide(),p=o.double(m=>o(`<div class="exlg-rand-settings exlg-unselectable exrand-entry">${m}</div>`).appendTo(y),"题目难度","题目来源");p[0].after(o('<span class="exlg-unselectable">&nbsp;&nbsp;</span>')),p[0].addClass("selected").css("margin-right","38px"),o.double(([m,w])=>{m.on("click",()=>{o(".exrand-entry").removeClass("selected"),m.addClass("selected"),o(".smallbtn-list").hide(),w.show()})},[p[0],C],[p[1],j]),o.double(([m,w,x])=>{let v=o.double(([k,M])=>o(`<span class="${k}">
        <span class="lg-small lg-inline-up exlg-unselectable">${M}</span>
        <br>
        </span>`).appendTo(m),["exrand-enabled","已选择"],["exrand-disabled","未选择"]);w.forEach((k,M)=>{let N=o.double(O=>o(`<div class="exlg-smallbtn exlg-unselectable">${k.text}</div>`).css("background-color",`var(--lg-${k.color}-problem)`).appendTo(O),v[0],v[1]);o.double(O=>{N[O].on("click",()=>{N[O].hide(),N[1-O].show(),x[M]=!!O}),x[M]===!!O&&N[O].hide()},0,1)})},[C,t,e.exrand_difficulty],[j,r,e.exrand_source]),o("#exlg-dash-0").on("mouseenter",()=>{i=!0,o.double(([m,w])=>{o.double(([x,v])=>{m.children(x).children(".exlg-smallbtn").each((k,M,N=o(M))=>w[k]===v?N.show():N.hide())},[".exrand-enabled",!0],[".exrand-disabled",!1])},[C,e.exrand_difficulty],[j,e.exrand_source]),u.show()}).on("mouseleave",()=>{i=!1,l||setTimeout(()=>{l||u.hide()},200)});let f=async()=>{let m=o.double(([ne,re,le])=>{let U=[];return ne.forEach((ie,ae)=>{re[ae]&&U.push(ie.id)}),U.length||(U=le),U[Math.floor(Math.random()*U.length)]},[t,e.exrand_difficulty,[0,1,2,3,4,5,6,7]],[r,e.exrand_source,["P"]]),w=await S(`/problem/list?difficulty=${m[0]}&type=${m[1]}&page=1`),x=w.currentData.problems.count,v=Math.ceil(x/50),k=Math.floor(Math.random()*v)+1;w=await S(`/problem/list?difficulty=${m[0]}&type=${m[1]}&page=${k}`);let M=w.currentData.problems.result,N=Math.floor(Math.random()*M.length),O=M[N].pid;location.href=`/problem/${O}`};g.on("click",f)},`
.exlg-rand-settings {
    position: relative;
    display: inline-block;
...
`);c.reg_chore("sponsor-list","获取标签列表","1D","@/.*",{tag_list:{ty:"string",priv:!0}},({msto:e})=>{P({url:"https://service-cmrlfv7t-1305163805.sh.apigw.tencentcs.com/release/get/0/0/",onload:t=>{e.tag_list=decodeURIComponent(t.responseText)}})});c.reg_hook_new("sponsor-tag","标签显示",["@/","@/paste","@/discuss/.*","@/problem/.*","@/ranking.*"],{tag_list:{ty:"string",priv:!0}},({args:e})=>{let t=JSON.parse(L["^sponsor-list"].tag_list),r=n=>{if(!n||n.hasClass("exlg-badge-username")||!/\/user\/[1-9][0-9]{0,}/.test(n.attr("href")))return;n.addClass("exlg-badge-username");let l=n.attr("href").slice(6),i=t[l];if(!i)return;let a=o(l==="100250"?`<span class="am-badge am-radius lg-bg-red" style="margin-left: 4px;">${i}</span>`:`<span class="exlg-badge">${i}</span>`).off("contextmenu").on("contextmenu",()=>!1).on("mousedown",d=>{d.button===2?location.href="https://www.luogu.com.cn/paste/asz40850":d.button===0&&J()}),s=n;s.next().length&&s.next().hasClass("sb_amazeui")&&(s=s.next()),s.next().length&&s.next().hasClass("am-badge")&&(s=s.next()),s.after(a)};e.each((n,l)=>r(o(l)))},e=>{let t=o(e.target).find("a[target='_blank'][href]");return{result:t.length,args:t}},()=>o("a[target='_blank'][href]"),`
.exlg-badge {
    border-radius: 50px;
    padding-left: 10px;
    padding-right: 10px;
...
`);c.reg_main("springboard","跨域跳板",["@bili/robots.txt?.*","@/robots.txt?.*"],null,()=>{let e=new URLSearchParams(location.search);switch(e.get("type")){case"update":document.write('<iframe src="https://service-nd5kxeo3-1305163805.sh.apigw.tencentcs.com/release/exlg-nextgen" exlg="exlg"></iframe>'),h.addEventListener("message",r=>{r.data.unshift("update"),h.parent.postMessage(r.data,"*")});break;case"page":let t=e.get("url");(!e.get("confirm")||confirm(`是否加载来自 ${t} 的页面？`))&&(document.body.innerHTML=`<iframe src="${t}" exlg="exlg"></iframe>`);break;case"dash":break}},`
    iframe {
        border: none;
        display: block;
        width: 100%;
...
`);c.reg("virtual-participation","创建重现赛","@/contest/[0-9]*(#.*)?",{vp_id:{ty:"string",dft:"0",priv:!0},orig_dat:{ty:"object",priv:!0,lvs:{pids:{ty:"string"},scrs:{ty:"string"}}}},({msto:e})=>{if(b.contest.id.toString()===e.vp_id){D("You cannot vp the virtual contest."),b.contest.startTime<=K(1e3)&&b.contestProblems.length===0&&B(`/fe/api/contest/editProblem/${e.vp_id}`,`{
                ...
                <p>开始时间：<input type="date" id="vpTmDt"/> <input type="time" id="vpTmClk"/></p>
                    ...
                    "hostID":${E.uid}
                }`,a=await B(`/fe/api/contest/${l?"new":"edit/"+e.vp_id}`,i);switch(a.status??200){case 200:e.vp_id=a.id.toString();break;case 404:e.vp_id=(await B("/fe/api/contest/new",i)).id.toString(),l=!0;break;default:T(`Failed to modify contest ${e.vp_id} with status code ${a.status}.`)}if(await B(`/fe/api/contest/editProblem/${e.vp_id}`,'{"pids":[],"scores":{"P1000":100}}'),l){let s=await S(`/contest/edit/${e.vp_id}`);B(`/fe/api/contest/join/${e.vp_id}`,`{"code": "${s.currentData.contest.joinCode}"}`)}location.href=`https://www.luogu.com.cn/contest/${e.vp_id}`})})},`
#exlg-vp {
    margin-right: .5em;
    display: inline-block;
    flex: none;
