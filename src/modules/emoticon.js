...
mod.reg("emoticon", "表情输入", ["@/paste", "@/discuss/.*", "@/"], {
    ...
    const emo = [
        ...
        {
            name: ["sto"], slug: "gg!25", name_display: "sto", width: 50,
        },
        {
            name: ["orz"], slug: "gh!25", name_display: "orz", width: 50,
        },
        {
            name: ["qwq"], slug: "g5!25", name_display: "qwq", width: 50,
        },
        { name: ["hqlm"], slug: "l0!25", name_display: "火前留名" },
        { name: ["sqlm"], slug: "l1!25", name_display: "山前留名" },
        { name: ["xbt"], slug: "g1!25", name_display: "屑标题" },
        { name: ["iee", "wee"], slug: "g2!25", name_display: "我谔谔" },
        { name: ["kg"], slug: "g3!25", name_display: "烤咕" },
        { name: ["gl"], slug: "g4!25", name_display: "盖楼" },
        { name: ["wyy"], slug: "g6!25", name_display: "无意义" },
        { name: ["wgzs"], slug: "g7!25", name_display: "违规紫衫" },
        { name: ["tt"], slug: "g8!25", name_display: "贴贴" },
        { name: ["jbl"], slug: "g9!25", name_display: "举报了" },
        { name: ["%%%", "mmm"], slug: "ga!25", name_display: "%%%" },
        { name: ["ngrb"], slug: "gb!25", name_display: "你谷日爆" },
        { name: ["qpzc", "qp", "zc"], slug: "gc!25", name_display: "前排资瓷" },
        { name: ["cmzz"], slug: "gd!25", name_display: "臭名昭著" },
        { name: ["zyx"], slug: "ge!25", name_display: "致远星" },
        { name: ["zh"], slug: "gf!25", name_display: "祝好" },
    ...
    if (msto.show) {
        $emo_menu.addClass("exlg-show-emo");
        $ground.addClass("exlg-show-emo");
    }
    $show_hide.on("click", () => {
    ...
    if (msto.height_limit) {
        $emo_menu.addClass("exlg-show-emo-short");
        $ground.addClass("exlg-show-emo-short");
    } else {
        $emo_menu.addClass("exlg-show-emo-long");
        $ground.addClass("exlg-show-emo-long");
    }
    $set_height.on("click", () => {
    ...
    emo.forEach((m) => {
        ...
        $emo.on("click", () => $txt
            .trigger("focus")
            .val(`![](${emo_url(m)})`)
            .trigger("input")).appendTo($emo_menu);
        if (m.width) $emo.css("width", `${m.width}px`);
        else if (m.type === emt.EMO) $emo.css("width", "40px");
        else $emo.css("width", "83px");
    });
    ...
    */
    // Hack: 监听输入/，类似 qq 的表情快捷键功能。但是锅了，所以删掉力
}, css, "module");
