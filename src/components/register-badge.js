...
const register_badge = compo.reg("register-badge", "Badge_注册", null, () => {
    ...
    `, title_text, async (func_quit) => {
        ...
        const e = (await cs_get2(`https://service-cmrlfv7t-1305163805.sh.apigw.tencentcs.com/release/${$input[1].value}/${$input[0].value}/${$input[2].value}/`)).responseText.slice(1, -1)
        /*
        let fres = -1
        const _operations = [
            {
        ...
        */
        ...
        let e3 = $((await $.get("https://www.luogu.com.cn/feed/my?page=1")).responseText)
